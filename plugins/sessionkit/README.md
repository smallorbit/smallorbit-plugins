...
A Claude Code plugin for session continuity, context handoffs, and meta-learning. Pick up exactly where you left off, plan through structured interviews, discover reusable skills from your work, and keep permission prompts from slowing you down.
...
| **interview** | `/interview [plan-file]` | Conducts a deep, structured interview to clarify and complete a plan. Challenges assumptions and inconsistencies until the plan is unambiguous. |
...
```
/interview docs/my-feature.md     # Deep-dive an existing plan file
/interview                        # Start from scratch — Claude will ask what to plan
```
