...
import CodeBlock from '../../components/post/CodeBlock.astro';
...
<Callout kit="flowkit">
  The reading layout is the visible payoff of Phase 0 design work. If it lands
  flat, the whole content effort lands flat.
</Callout>
...
For commands you want readers to follow line-by-line, the `<CodeBlock lineNumbers>`
component wraps a fenced block and renders a left-side gutter:
